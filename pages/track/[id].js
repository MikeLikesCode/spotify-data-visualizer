    ...
    <Layout>
      <div className="flex items-center py-20 px-10">
        ...
        <div className="ml-10">
          ...
          <a target="_blank" rel="noreferrer" href={data.external_urls.spotify} className="flex w-60 justify-center items-center bg-[#1db954] px-2 py-[6px] text-md rounded-full uppercase font-medium"> <span><Spotify className="text-white text-xl mr-2"/></span> Listen on Spotify</a>
        </div>
      </div>
    </Layout>
  );
